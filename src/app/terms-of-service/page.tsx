...
export const metadata: Metadata = {
  title: 'Terms of Service | Sophos Technology Consultancy LLC',
};
    ...
    <>
      ...
      <section style={{ padding: '54px 0' }}>
        <div className="r-container" style={containerStyle}>
          ...
          <p style={pStyle}><strong>For the purposes of these Terms and Conditions:</strong></p>
          ...
          <h3 style={h3Style}>Acknowledgment</h3>
          <p style={pStyle}>
          ...
          <h3 style={h3Style}>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h3>
          <p style={pStyle}>
          ...
          <h3 style={h3Style}>Disputes Resolution</h3>
          <p style={pStyle}>
            If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
          </p>

          <h3 style={h3Style}>For European Union (EU) Users</h3>
          <p style={pStyle}>
            If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.
          </p>

          <h3 style={h3Style}>United States Legal Compliance</h3>
          <p style={pStyle}>
            You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
          </p>

          <h3 style={h3Style}>Severability and Waiver</h3>
          <p style={pStyle}>
          ...
          <h3 style={h3Style}>Changes to These Terms and Conditions</h3>
          <p style={pStyle}>
          ...
          <p style={pStyle}>If you have any questions about these Terms and Conditions, You can contact us:</p>
          <ul style={{ ...pStyle, paddingLeft: '20px' }}>
