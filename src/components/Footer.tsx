    ...
    <footer style={{ backgroundColor: '#ffffff', padding: '60px 0 0 0' }}>
      <div className="r-container" style={{ maxWidth: '1080px', width: '80%', margin: '0 auto' }}>
        <div className="r-footer-cols" style={{ display: 'flex', flexWrap: 'wrap' as const, gap: '40px', justifyContent: 'space-between' }}>
          ...
          <div className="r-footer-logo-col" style={{ flex: '1 1 300px', maxWidth: '400px' }}>
            <Image
              src="/images/logo.png"
              alt="Sophos Technology Consultancy LLC"
              width={193}
              height={85}
              style={{ width: 'auto', height: 'auto', opacity: 0.5, marginBottom: '20px', maxWidth: '160px' }}
            />
          ...
          {/* Column 2: Menu */}
          <div className="r-footer-link-col" style={{ flex: '0 1 150px' }}>
