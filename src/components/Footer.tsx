...
export default function Footer() {
  return (
    <footer className="r-footer">
      <div className="r-container r-footer-container">
        <div className="r-footer-cols">
          {/* Column 1: Logo & Description */}
          <div className="r-footer-logo-col">
            <Image
              src="/images/logo.png"
        ...
        <div className="r-footer-divider">
          <div className="r-footer-bottom">
            ...
            <div className="r-footer-socials">
              ...
              <a href="https://twitter.com/sophostc" target="_blank" rel="noopener noreferrer" className="r-social-icon">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href="https://linkedin.com/company/sophostc" target="_blank" rel="noopener noreferrer" className="r-social-icon">
