        ...
        <div style={{ borderTop: '1px solid #e0e0e0', marginTop: '40px', paddingTop: '25px', paddingBottom: '25px' }}>
          <div className="r-footer-bottom" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' as const, gap: '15px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              {/* GitHub */}
              <a href="https://github.com/sophostc" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px', borderRadius: '50%', backgroundColor: '#444', color: '#fff' }}>
              ...
              {/* X/Twitter */}
              <a href="https://twitter.com/sophostc" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px', borderRadius: '50%', backgroundColor: '#444', color: '#fff' }}>
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              {/* LinkedIn */}
              <a href="https://linkedin.com/company/sophostc" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px', borderRadius: '50%', backgroundColor: '#444', color: '#fff' }}>
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
